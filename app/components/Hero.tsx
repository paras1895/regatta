...
const Hero: React.FC = () => {
  ...
  return (
    <Section>
      <div className="hero-fonts relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl px-6 md:px-12 animate-hero-fade-up">
          ...
          <p className="font-sans text-lg md:text-xl text-neutral-600 dark:text-neutral-300 max-w-2xl mt-8">
            India's oldest college festival, where tradition flows forward and
            every stroke carries the spirit of generations past.
          </p>

          <p className="font-sans uppercase tracking-widest text-sm text-neutral-500 mt-6">
