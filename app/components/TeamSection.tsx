                  ...
                  >
                    ...
                    <div className="mt-5 flex gap-3">
                      {p.email && (
                        <a
                          href={`mailto:${p.email}`}
                          className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-50 text-gray-400 hover:text-black hover:bg-gray-100 transition-all border border-gray-100"
                        >
